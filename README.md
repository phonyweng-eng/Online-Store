...
async function placeOrder(){
    ...
    // Create a text list of everything in the cart
    ...
    try {
        ...
        if (response.ok) {
            alert("Success! phonyweng@gmail.com will receive your order.");
            cart = [];
            updateCart();
            ...
            // This happens if the email isn't verified yet
            alert("Submission failed. Check phonyweng@gmail.com to verify your form!");
        }
    } catch (err) {
