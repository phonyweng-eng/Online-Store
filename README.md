...
<!-- Added an ID to the button to show status -->
<button id="submitBtn" onclick="placeOrder()">Place Order</button>
</div>

<script>
// Your original product list - No changes made
const products=[
{id:1, name:"Soda Can", price: 45, image: "[https://i5.walmartimages.com/seo/Coca-Cola-Soda-Pop-12-fl-oz-Can_14a1f5dc-f8bf-4071-9aea-0f753c3eecf4.08041b7f0a409ee67d80e489be3c1c55.jpeg](https://sprinkleskosher.com/lakewood-todd-plaza/product/soda-can/)"},
...
// UPDATED FUNCTION: This sends the data to phonyweng@gmail.com
...
if (response.ok) {
alert("Order Confirmed! Check phonyweng@gmail.com shortly.");
cart=[];
updateCart();
